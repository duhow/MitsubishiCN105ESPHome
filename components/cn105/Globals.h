...
static const uint8_t WIDEVANE_TOTAL_STATES = 7; // total number of wide vane settings
static const uint8_t WIDEVANE[WIDEVANE_TOTAL_STATES] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x08, 0x0c };
static const char* WIDEVANE_MAP[WIDEVANE_TOTAL_STATES] = { "←←", "←", "|", "→", "→→", "←→", "SWING" };
